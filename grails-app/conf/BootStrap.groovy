import com.chromworks.rest.City
...
class BootStrap {
    ...
    private void seedTestData() {
        ...
        city = new City(cityName: 'Boston', postalCode: "02446", countryCode: 'US')
        assert city.save(failOnError:true, flush:true, insert: true)
        city.errors = null
 
        city = new City(cityName: 'Tampa', postalCode: "33647", countryCode: 'US')
        assert city.save(failOnError:true, flush:true, insert: true)
        city.errors = null
